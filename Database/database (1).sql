...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 16, 2023 at 05:40 PM
...
INSERT INTO `accounts` (`User_ID`, `Email_or_Phone`, `Username`, `Password`, `role`) VALUES
(1, 'Admin@gmail.com', 'Admin', 'admin123!', 'admin'),
(2, 'WizKhalifaXG1@gmail.com', 'WizKhalifaXG1', '123456', 'user');
...
(1, 'Another Comment Testing', 'Another comment testing and we will update this later or sooner.', 0, '2023-11-18 04:50:07'),
(2, 'Another New Posts ', 'Another new posts to be tested out and I hope it works.', 0, '2023-11-18 05:16:28'),
(3, 'This is a new pop up test moda', 'Testing only for pop up post modal submit', 0, '2023-11-18 06:01:14'),
(4, 'Another New Post Modal', 'Testing of new post modal again once again', 0, '2023-11-18 06:12:12');
...
--
ALTER TABLE `comments`
  MODIFY `comment_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
